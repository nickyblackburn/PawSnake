(() => {
  ...
  function confettiWin(){
    ...
    (function frame(){
      confettiCannon({particleCount:5,angle:60,spread:55,startVelocity:45,origin:{x:0,y:0.6}});
      confettiCannon({particleCount:5,angle:120,spread:55,startVelocity:45,origin:{x:1,y:0.6}});
